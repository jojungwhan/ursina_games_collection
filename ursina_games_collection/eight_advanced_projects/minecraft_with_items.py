...
textures = {
  "grass": load_texture("minecraft_tut/assets/textures/groundEarth.png"),
  "dirt": load_texture("minecraft_tut/assets/textures/groundMud.png"),
  "stone": load_texture("minecraft_tut/assets/textures/wallStone.png"),
  "bedrock": load_texture("minecraft_tut/assets/textures/stone07.png"),
  "barrier": load_texture("minecraft_tut/assets/textures/barrier01.png")
}

models = {
  "block": "minecraft_tut/assets/models/block_model",
  "poppy": "minecraft_tut/assets/models/poppy_model"
}
